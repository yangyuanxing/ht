hteditor.strings = {
    ...
    'url:scenes': '场景根目录',
    'url:models': '模型根目录',
    'url:displays/htdesign': '图扑设计',
    'url:symbols/htdesign': '图扑设计',
    'url:scenes/htdesign': '图扑设计',
    'url:models/htdesign': '图扑设计',
    'url:assets/htdesign': '图扑设计',
    'url:displays/ht': '图扑预制',
    'url:symbols/ht': '图扑预制',
    'url:components/ht': '图扑预制',
    ...
    'url:symbols/ht/snapshot/textarea.json': '文本域',
    'url:symbols/ht/snapshot/inputNumber.json': '数字输入框',
    'url:symbols/ht/chart': '图表',
    'url:symbols/ht/demo': '案例',
    'url:symbols/ht/chart/pieChart.json': '简易饼图',
    'url:symbols/ht/chart/columnChart.json': '简易棒图',
    'url:symbols/ht/chart/columnChart2.json': '简易棒图2',
    'url:symbols/ht/chart/lineChart.json': '简易折线图',
    'url:symbols/ht/chart/chart.json': '直角坐标图表',
    'url:symbols/ht/chart/pie.json': '饼图',
    'url:symbols/ht/chart/timeAxisChart.json': '时间轴图表',
    ...
    'url:symbols/ht/ui/carousel.json': '轮播1',
    'url:symbols/ht/ui/carousel2.json': '轮播2',
    ...
    'url:symbols/ht/text': '文本',
    'url:symbols/ht/text/multilineText.json': '多行文本',
    'url:symbols/ht/text/richTextPane.json': '富文本面板',
    'url:symbols/ht/text/verticalTextBox.json': '竖直文本盒',
    'url:symbols/ht/text/textBox.json': '文本盒',
    'url:symbols/ht/text/textEllipsis.json': '文本省略',
    ...
    'url:components/ht/ui/textarea.json': '文本域',
    ...
    'url:components/ht/ui/inputNumber.json': '数字输入框',
    'url:components/ht/ui/carousel.json': '轮播1',
    'url:components/ht/ui/carousel2.json': '轮播2',
    'url:components/ht/ui/radioButton.json': '单选按钮组',
    'url:components/ht/ui/tree.json': '树',
    'url:components/ht/text': '文本',
    'url:components/ht/text/multilineText.json': '多行文本',
    'url:components/ht/text/richTextPane.json': '富文本面板',
    'url:components/ht/text/textBox.json': '文本盒',
    'url:components/ht/text/verticalTextBox.json': '竖直文本盒',
    'url:components/ht/text/verticalTextBox.json': '竖直文本盒',
    'url:components/ht/text/textEllipsis.json': '文本省略',
    'url:components/ht/chart': '图表',
    'url:components/ht/chart/chart.json': '直角坐标图表',
    'url:components/ht/chart/pie.json': '饼图',
    'url:components/ht/chart/timeAxisChart.json': '时间轴图表',
    'ht.Data': '图元',
    'ht.Node': '节点',
    'ht.Edge': '连线',
    'ht.Shape': '不规则图形',
